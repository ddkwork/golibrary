...
func (o *Buffer) Marshal(obj IStruct) error {
	...
	if err == nil {
		...
		s := o.size_struct(props, base)
		o.buf = make([]byte, s)
		err = o.enc_struct(props, base)
	}
	return err
}
...
func (o *Buffer) Unmarshal(obj IStruct) error {
	typ, base, err := getbase(obj)
	if err != nil {
		return err
	}

	return o.unmarshalType(typ.Elem(), GetProperties(typ.Elem()), base)
}
