...
func TestName(t *testing.T) {
	err := Compress("JetBrainsGateway-222.4459.11", "a.tar.gz")
	if err != nil {
		panic(err.Error())
	}
	return
	p := "/data/data/com.termux/files/home/storage/downloads/ide/JetBrainsGateway-222.4459.11.tar.gz"
	err = Extract(p, ".")
	if err != nil {
		panic(err.Error())
	}
	return
	filepath.Walk("/data/data/com.termux/files/home/storage/downloads/ide/", func(path string, info fs.FileInfo, err error) error {
		println(path)
		return err
	})
}
